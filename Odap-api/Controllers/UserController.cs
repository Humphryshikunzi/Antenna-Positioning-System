...
using Odap.Models;
using OdapApi.Constants;
using OdapApi.Data;
using OdapApi.Models.Dtos;
using OdapApi.Models.UserEntity;
using System;
...
namespace Rtgsms.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        private OdapDbContext  _rtgsmsDbContext;
        private readonly UserManager<AppUser> _userManager;
        private readonly AppSettings _appSettings;
        #endregion

        public UserController(SignInManager<AppUser> signInManager, OdapDbContext rtgsmsDbContext, IOptions<AppSettings> appSettings, UserManager<AppUser> userManager)
        {
        ...
        private string GenerateJwtToken(AppUser user)
        {
            ...
            var token = new JwtSecurityToken("Odap.com", claims: claims, expires: expires, signingCredentials: creds);
