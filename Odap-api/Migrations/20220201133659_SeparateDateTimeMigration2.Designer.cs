...
{
    [DbContext(typeof(OdapDbContext))]
    [Migration("20220201133659_SeparateDateTimeMigration2")]
    partial class SeparateDateTimeMigration2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Odap.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OdapApi.Models.Device.DeviceData", b =>
                {
                    ...
                    b.Property<string>("DirectionNorthSouth")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Odap.Models.AppUser", null)
                        .WithMany()
